...
var np = require('./../parsers/surebet').getSurebetParser();
...
var options = {
    uri: 'https://www.surebet247.com/bets/event/argentina---colombia/2982122',
...
$('.event_game_title', root).each(function (indx, elem) {
    ...
    if( tag == nparser.straight_win_tag)
    {
        ...
        console.log(helper.validate_odds(odds, 3))
