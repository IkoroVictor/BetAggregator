    ...
    $('#betsTable').children().each(function (indx, elem) {
        ...
        if (tag == nparser.straight_win_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data["odds.1.mb.outcome_id"] = outcome_ids[0];
                temp_data["odds.x.mb.outcome_id"] = outcome_ids[1];
                temp_data["odds.2.mb.outcome_id"] = outcome_ids[2];
            }
        ...
        if (tag == nparser.handicap_0_1_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.handicap_0_1_1.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.handicap_0_1_x.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.handicap_0_1_2.mb.outcome_id'] = outcome_ids[2]
        ...
        if (tag == nparser.handicap_0_2_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.handicap_0_2_1.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.handicap_0_2_x.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.handicap_0_2_2.mb.outcome_id'] = outcome_ids[2]
            }
        ...
        if (tag == nparser.handicap_1_0_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.handicap_1_0_1.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.handicap_1_0_x.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.handicap_1_0_2.mb.outcome_id'] = outcome_ids[2]
            }
        ...
        if (tag == nparser.handicap_2_0_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.handicap_2_0_1.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.handicap_2_0_x.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.handicap_2_0_2.mb.outcome_id'] = outcome_ids[2]
        ...
        if (tag == nparser.double_chance_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.1x.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.12.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.x2.mb.outcome_id'] = outcome_ids[2]
        ...
        if (tag == nparser.double_chance_first_half_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.1x_half.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.12_half.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.x2_half.mb.outcome_id'] = outcome_ids[2]
        ...
        if (tag == nparser.double_chance_second_half_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.1x_half_2.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.12_half_2.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.x2_half_2.mb.outcome_id'] = outcome_ids[2]
        ...
        if (tag == nparser.first_half_result_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.1_half.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.x_half.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.2_half.mb.outcome_id'] = outcome_ids[2]
        ...
        if (tag == nparser.second_half_result_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.1_half_2.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.x_half_2.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.2_half_2.mb.outcome_id'] = outcome_ids[2]
            }
        ...
        if (tag == nparser.most_scoring_half_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.most_scoring_half.half.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.most_scoring_half.half_2.mb.outcome_id'] = outcome_ids[2];
                temp_data['odds.most_scoring_half.equal.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.to_score_first_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.first_goal.home.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.first_goal.away.mb.outcome_id'] = outcome_ids[2];
                temp_data['odds.first_goal.no_goal.mb.outcome_id'] = outcome_ids[1]
            }
        ...
        if (tag == nparser.to_score_last_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.last_goal.home.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.last_goal.away.mb.outcome_id'] = outcome_ids[2];
                temp_data['odds.last_goal.no_goal.mb.outcome_id'] = outcome_ids[1]
            }
        ...
        if (tag == nparser.first_goal_time_tag) {
            ...
            try {
                ...
                for (var i = 0; i < val.odds.length; i++) {
                    ...
                    temp_data['odds.first_goal_time.' + nparser.clean(val.keys[i]).toLowerCase() + '.mb.outcome_id'] = outcome_ids[i];
                }
        ...
        if (tag == nparser.home_no_bet_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.home_no_bet.x.mb.value'] = odds[0];
                temp_data['odds.home_no_bet.away.mb.value'] = odds[1]

                temp_data['odds.home_no_bet.x.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.home_no_bet.away.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.away_no_bet_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.away_no_bet.home.mb.value'] = odds[0];
                temp_data['odds.away_no_bet.x.mb.value'] = odds[1]

                temp_data['odds.away_no_bet.home.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.away_no_bet.x.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.draw_no_bet_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.draw_no_bet.home.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.draw_no_bet.away.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.draw_no_bet_first_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.draw_no_bet_half.home.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.draw_no_bet_half.away.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.draw_no_bet_second_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.draw_no_bet_half_2.home.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.draw_no_bet_half_2.away.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_0_5_first_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under0_5_half.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over0_5_half.mb.outcome_id'] = outcome_ids[1]
            }
        ...
        if (tag == nparser.under_over_1_5_first_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under1_5_half.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over1_5_half.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_2_5_first_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under2_5_half.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over2_5_half.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_0_5_second_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under0_5_half_2.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over0_5_half_2.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_1_5_second_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under1_5_half_2.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over1_5_half_2.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_2_5_second_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under2_5_half_2.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over2_5_half_2.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_0_5_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under0_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over0_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_1_5_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under1_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over1_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_2_5_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under2_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over2_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_3_5_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under3_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over3_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_4_5_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under4_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over4_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_5_5_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under5_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over5_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_6_5_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under6_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over6_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_7_5_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under7_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over7_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.clean_symbols(game.home.toLowerCase()) + nparser.under_over_0_5_tag) {
            odds = nparser.parse_basic_op($(this).next(), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.home_under0_5.mb.value'] = odds[0];
                temp_data['odds.home_over0_5.mb.value'] = odds[1];

                temp_data['odds.home_under0_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.home_over0_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.clean_symbols(game.home.toLowerCase()) + nparser.under_over_1_5_tag) {
            odds = nparser.parse_basic_op($(this).next(), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.home_under1_5.mb.value'] = odds[0];
                temp_data['odds.home_over1_5.mb.value'] = odds[1];

                temp_data['odds.home_under1_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.home_over1_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.clean_symbols(game.home.toLowerCase()) + nparser.under_over_2_5_tag) {
            odds = nparser.parse_basic_op($(this).next(), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.home_under2_5.mb.value'] = odds[0];
                temp_data['odds.home_over2_5.mb.value'] = odds[1];

                temp_data['odds.home_under2_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.home_over2_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.clean_symbols(game.home.toLowerCase()) + nparser.under_over_3_5_tag) {
            odds = nparser.parse_basic_op($(this).next(), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.home_under3_5.mb.value'] = odds[0];
                temp_data['odds.home_over3_5.mb.value'] = odds[1];

                temp_data['odds.home_under3_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.home_over3_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.clean_symbols(game.away.toLowerCase()) + nparser.under_over_0_5_tag) {
            odds = nparser.parse_basic_op($(this).next(), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.away_under0_5.mb.value'] = odds[0];
                temp_data['odds.away_over0_5.mb.value'] = odds[1];

                temp_data['odds.away_under0_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.away_over0_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.clean_symbols(game.away.toLowerCase()) + nparser.under_over_1_5_tag) {
            odds = nparser.parse_basic_op($(this).next(), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.away_under1_5.mb.value'] = odds[0];
                temp_data['odds.away_over1_5.mb.value'] = odds[1];

                temp_data['odds.away_under1_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.away_over1_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.clean_symbols(game.away.toLowerCase()) + nparser.under_over_2_5_tag) {
            odds = nparser.parse_basic_op($(this).next(), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.away_under2_5.mb.value'] = odds[0];
                temp_data['odds.away_over2_5.mb.value'] = odds[1];

                temp_data['odds.away_under2_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.away_over2_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.clean_symbols(game.away.toLowerCase()) + nparser.under_over_3_5_tag) {
            odds = nparser.parse_basic_op($(this).next(), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.away_under3_5.mb.value'] = odds[0];
                temp_data['odds.away_over3_5.mb.value'] = odds[1];

                temp_data['odds.away_under3_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.away_over3_5.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.both_teams_to_score_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.bts.yes.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.bts.no.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.both_teams_to_score_first_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.bts_half.yes.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.bts_half.no.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.both_teams_to_score_second_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.bts_half_2.yes.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.bts_half_2.no.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.total_goals_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.total_goals.odd.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.total_goals.even.mb.outcome_id'] = outcome_ids[1]
        ...
        if (nparser.clean_symbols(tag) == nparser.total_goals_first_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.total_goals_half.odd.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.total_goals_half.even.mb.outcome_id'] = outcome_ids[1]
        ...
        if (nparser.clean_symbols(tag) == nparser.total_goals_second_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.total_goals_half_2.odd.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.total_goals_half_2.even.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_0_5_cards_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under0_5_card.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over0_5_card.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_1_5_cards_tag) {
            odds = nparser.parse_basic_op($(this).next(), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.odds.under1_5_card.mb.value'] = odds[0];
                temp_data['odds.odds.over1_5_card.mb.value'] = odds[1]


                temp_data['odds.under1_5_card.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over1_5_card.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_2_5_cards_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under2_5_card.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over2_5_card.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_3_5_cards_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under3_5_card.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over3_5_card.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_4_5_cards_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under4_5_card.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over4_5_card.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_5_5_cards_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under5_5_card.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over5_5_card.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_6_5_cards_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under6_5_card.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over6_5_card.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_0_5_cards_first_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under0_5_card_half.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over0_5_card_half.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_1_5_cards_first_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under1_5_card_half.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over1_5_card_half.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_2_5_cards_first_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under2_5_card_half.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over2_5_card_half.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_3_5_cards_first_half_tag) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.under3_5_card_half.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over3_5_card_half.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_0_5_cards_second_half_tag) {
            odds = nparser.parse_basic_op($(this).next(), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.odds.under0_5_card_half_2.mb.value'] = odds[0];
                temp_data['odds.odds.over0_5_card_half_2.mb.value'] = odds[1]


                temp_data['odds.under0_5_card_half_2.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over0_5_card_half_2.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_1_5_cards_second_half_tag) {
            odds = nparser.parse_basic_op($(this).next(), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.odds.under1_5_card_half_2.mb.value'] = odds[0];
                temp_data['odds.odds.over1_5_card_half_2.mb.value'] = odds[1]

                temp_data['odds.under1_5_card_half_2.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over1_5_card_half_2.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_2_5_cards_second_half_tag) {
            odds = nparser.parse_basic_op($(this).next(), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.odds.under2_5_card_half_2.mb.value'] = odds[0];
                temp_data['odds.odds.over2_5_card_half_2.mb.value'] = odds[1];

                temp_data['odds.under2_5_card_half_2.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over2_5_card_half_2.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.under_over_3_5_cards_second_half_tag) {
            odds = nparser.parse_basic_op($(this).next(), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.odds.under3_5_card_half_2.mb.value'] = odds[0];
                temp_data['odds.odds.over3_5_card_half_2.mb.value'] = odds[1]

                temp_data['odds.under3_5_card_half_2.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.over3_5_card_half_2.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.halftime_fulltime_tag) {
            ...
            if (helper.validate_odds(odds, 9)) {
                ...
                temp_data['odds.halftime_fulltime.home_home.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.halftime_fulltime.home_x.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.halftime_fulltime.home_away.mb.outcome_id'] = outcome_ids[2];
                temp_data['odds.halftime_fulltime.x_home.mb.outcome_id'] = outcome_ids[3];
                temp_data['odds.halftime_fulltime.x_x.mb.outcome_id'] = outcome_ids[4];
                temp_data['odds.halftime_fulltime.x_away.mb.outcome_id'] = outcome_ids[5];
                temp_data['odds.halftime_fulltime.away_home.mb.outcome_id'] = outcome_ids[6];
                temp_data['odds.halftime_fulltime.away_x.mb.outcome_id'] = outcome_ids[7];
                temp_data['odds.halftime_fulltime.away_away.mb.outcome_id'] = outcome_ids[8]
        ...
        if (tag == (nparser.total_goals_tag + '(.' + nparser.clean_symbols(game.home.toLowerCase()) + ')' )) {
            ...
            if (helper.validate_odds(odds, 4)) {
                ...
                temp_data['odds.team_total_goals.home.0.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.team_total_goals.home.1.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.team_total_goals.home.2.mb.outcome_id'] = outcome_ids[2];
                temp_data['odds.team_total_goals.home.3+.mb.outcome_id'] = outcome_ids[3]
        ...
        if (tag == (nparser.total_goals_tag + '(.' + nparser.clean_symbols(game.away.toLowerCase()) + ')' )) {
            ...
            if (helper.validate_odds(odds, 4)) {
                ...
                temp_data['odds.team_total_goals.away.0.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.team_total_goals.away.1.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.team_total_goals.away.2.mb.outcome_id'] = outcome_ids[2];
                temp_data['odds.team_total_goals.away.3+.mb.outcome_id'] = outcome_ids[3]
        ...
        if (tag == (nparser.correct_score_tag )) {
            ...
            for (var i = 0; i < val.odds.length; i++) {
                ...
                temp_data['odds.correct_score.' + nparser.clean_symbols(val.keys[i]) + '.mb.outcome_id'] = outcome_ids[i];
            }
        ...
        if (tag == (nparser.correct_score_others_tag )) {
            ...
            for (var i = 0; i < val.odds.length; i++) {
                temp_data['odds.correct_score_others.' + nparser.clean_symbols(val.keys[i]) + '.mb.value'] = val.odds[i];
                temp_data['odds.correct_score_others.' + nparser.clean_symbols(val.keys[i]) + '.mb.outcome_id'] = outcome_ids[i];
            }
        ...
        if (tag == (nparser.correct_score_first_half_tag )) {
            ...
            for (var i = 0; i < val.odds.length; i++) {
                ...
                temp_data['odds.correct_score_half.' + nparser.clean_symbols(val.keys[i]) + '.mb.outcome_id'] = outcome_ids[i];
        ...
        if (tag == (nparser.correct_score_second_half_tag )) {
            ...
            for (var i = 0; i < val.odds.length; i++) {
                ...
                temp_data['odds.correct_score_half_2.' + nparser.clean_symbols(val.keys[i]) + '.mb.outcome_id'] = outcome_ids[i];
        ...
        if (tag == nparser.ten_minutes_tag) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.ten_mins.1.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.ten_mins.x.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.ten_mins.2.mb.outcome_id'] = outcome_ids[2]
        ...
        if (tag == ( nparser.clean_symbols(game.home.toLowerCase()) + nparser.most_scoring_half_tag)) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.home_most_scoring_half.half.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.home_most_scoring_half.half_2.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.home_most_scoring_half.equal.mb.outcome_id'] = outcome_ids[2]
        ...
        if (tag == ( nparser.clean_symbols(game.away.toLowerCase()) + nparser.most_scoring_half_tag)) {
            ...
            if (helper.validate_odds(odds, 3)) {
                ...
                temp_data['odds.away_most_scoring_half.half.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.away_most_scoring_half.half_2.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.away_most_scoring_half.equal.mb.outcome_id'] = outcome_ids[2]
        ...
        if (tag == ("firstteam" + nparser.clean_sheet_tag)) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.home_clean_sheet.yes.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.home_clean_sheet.no.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == ("awayteam" + nparser.clean_sheet_tag)) {
            ...
            if (helper.validate_odds(odds, 2)) {
                ...
                temp_data['odds.away_clean_sheet.yes.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.away_clean_sheet.no.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == ( "awayteam" + nparser.clean_sheet_half_tag)) {
            odds = nparser.parse_basic_op($(this), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.away_clean_sheet_half.yes.mb.value'] = odds[0];
                temp_data['odds.away_clean_sheet_half.no.mb.value'] = odds[1]

                temp_data['odds.away_clean_sheet_half.yes.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.away_clean_sheet_half.no.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == ( "firstteam" + nparser.clean_sheet_half_2_tag)) {
            ...
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.home_clean_sheet_half_2.yes.mb.value'] = odds[0];
                temp_data['odds.home_clean_sheet_half_2.no.mb.value'] = odds[1]

                temp_data['odds.home_clean_sheet_half_2.yes.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.home_clean_sheet_half_2.no.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == ( "awayteam" + nparser.clean_sheet_half_2_tag)) {
            odds = nparser.parse_basic_op($(this), $);
            if (helper.validate_odds(odds, 2)) {
                temp_data['odds.away_clean_sheet_half_2.yes.mb.value'] = odds[0];
                temp_data['odds.away_clean_sheet_half_2.no.mb.value'] = odds[1]

                temp_data['odds.away_clean_sheet_half_2.yes.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.away_clean_sheet_half_2.no.mb.outcome_id'] = outcome_ids[1]
        ...
        if (tag == nparser.winning_margin_tag) {
            ...
            if (helper.validate_odds(odds, 7)) {
                ...
                temp_data['odds.win_margin.home_1.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.win_margin.home_2.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.win_margin.home_3+.mb.outcome_id'] = outcome_ids[2];
                temp_data['odds.win_margin.away_1.mb.outcome_id'] = outcome_ids[3];
                temp_data['odds.win_margin.away_2.mb.outcome_id'] = outcome_ids[4];
                temp_data['odds.win_margin.away_3+.mb.outcome_id'] = outcome_ids[5];
                temp_data['odds.win_margin.x.mb.outcome_id'] = outcome_ids[6]
        ...
        if (tag == nparser.result_and_under_over_0_5_tag) {
            ...
            if (helper.validate_odds(odds, 6)) {
                ...
                temp_data['odds.home_win_under0_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.home_win_over0_5.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.draw_under0_5.mb.outcome_id'] = outcome_ids[2];
                temp_data['odds.draw_over0_5.mb.outcome_id'] = outcome_ids[3];
                temp_data['odds.away_win_under0_5.mb.outcome_id'] = outcome_ids[4];
                temp_data['odds.away_win_over0_5.mb.outcome_id'] = outcome_ids[5]
        ...
        if (tag == nparser.result_and_under_over_1_5_tag) {
            ...
            if (helper.validate_odds(odds, 6)) {
                ...
                temp_data['odds.home_win_under1_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.home_win_over1_5.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.draw_under1_5.mb.outcome_id'] = outcome_ids[2];
                temp_data['odds.draw_over1_5.mb.outcome_id'] = outcome_ids[3];
                temp_data['odds.away_win_under1_5.mb.outcome_id'] = outcome_ids[4];
                temp_data['odds.away_win_over1_5.mb.outcome_id'] = outcome_ids[5]
        ...
        if (tag == nparser.result_and_under_over_2_5_tag) {
            ...
            if (helper.validate_odds(odds, 6)) {
                ...
                temp_data['odds.home_win_under2_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.home_win_over2_5.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.draw_under2_5.mb.outcome_id'] = outcome_ids[2];
                temp_data['odds.draw_over2_5.mb.outcome_id'] = outcome_ids[3];
                temp_data['odds.away_win_under2_5.mb.outcome_id'] = outcome_ids[4];
                temp_data['odds.away_win_over2_5.mb.outcome_id'] = outcome_ids[5]
        ...
        if (tag == nparser.result_and_under_over_3_5_tag) {
            ...
            if (helper.validate_odds(odds, 6)) {
                ...
                temp_data['odds.home_win_under3_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.home_win_over3_5.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.draw_under3_5.mb.outcome_id'] = outcome_ids[2];
                temp_data['odds.draw_over3_5.mb.outcome_id'] = outcome_ids[3];
                temp_data['odds.away_win_under3_5.mb.outcome_id'] = outcome_ids[4];
                temp_data['odds.away_win_over3_5.mb.outcome_id'] = outcome_ids[5]
        ...
        if (tag == nparser.result_and_under_over_4_5_tag) {
            ...
            if (helper.validate_odds(odds, 6)) {
                ...
                temp_data['odds.home_win_under4_5.mb.outcome_id'] = outcome_ids[0];
                temp_data['odds.home_win_over4_5.mb.outcome_id'] = outcome_ids[1];
                temp_data['odds.draw_under4_5.mb.outcome_id'] = outcome_ids[2];
                temp_data['odds.draw_over4_5.mb.outcome_id'] = outcome_ids[3];
                temp_data['odds.away_win_under4_5.mb.outcome_id'] = outcome_ids[4];
                temp_data['odds.away_win_over4_5.mb.outcome_id'] = outcome_ids[5]
        ...
        if (tag == (nparser.number_of_goals_tag )) {
            ...
            for (var i = 0; i < val.odds.length; i++) {
                ...
                temp_data['odds.number_of_goals.' + nparser.clean(val.keys[i])+'.mb.outcome_id']  = outcome_ids[i];
        ...
        if (tag == (nparser.number_of_goals_first_half_tag )) {
            var val = nparser.parse_op_with_keys($(this).next(), $);
            for (var i = 0; i < val.odds.length; i++) {
                temp_data['odds.number_of_goals_half.' + nparser.clean(val.keys[i])+'.mb.value']  = val.odds[i];
                temp_data['odds.number_of_goals_half.' + nparser.clean(val.keys[i])+'.mb.outcome_id']  = outcome_ids[i];
        ...
        if (tag == (nparser.number_of_goals_second_half_tag )) {
            var val = nparser.parse_op_with_keys($(this).next(), $);
            for (var i = 0; i < val.odds.length; i++) {
                temp_data['odds.number_of_goals_half_2.' + nparser.clean(val.keys[i])+'.mb.value']  = val.odds[i];
                temp_data['odds.number_of_goals_half_2.' + nparser.clean(val.keys[i])+'.mb.outcome_id']  = outcome_ids[i];
        ...
        if (tag == nparser.first_scorer_tag) {
            ...
            try {
                ...
                for (var i = 0; i < val.odds.length; i++) {
                    temp_data['odds.first_scorer.' + helper.fix_scorers(val.keys[i]).toLowerCase() + '.mb.value'] = val.odds[i];
                    temp_data['odds.first_scorer.' + helper.fix_scorers(val.keys[i]).toLowerCase() + '.mb.outcome_id'] = outcome_ids[i];
                }
        ...
        if (tag == nparser.last_scorer_tag) {
            ...
            try {
                ...
                for (var i = 0; i < val.odds.length; i++) {
                    temp_data['odds.last_scorer.' + helper.fix_scorers(val.keys[i]).toLowerCase() + '.mb.value'] = val.odds[i];
                    temp_data['odds.last_scorer.' + helper.fix_scorers(val.keys[i]).toLowerCase() + '.mb.outcome_id'] = outcome_ids[i];
                }
